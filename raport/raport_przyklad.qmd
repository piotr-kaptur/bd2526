...
Wszyscy rekordziści niezależnie od konkurencji osiągają czasy w okolicy 15 sekund. Chomiki rasy rumuńskiej trzymają nawjwięcej bo aż 3 z 5 rekordów.
...
Okazuje się że pieniądze nie mają wpływu na wyniki zawodników niezależnie od dyscypliny. Bardzo dobrze finansowane chomiki (powyżej 0.6M) osiągają częsciej średnie czasy (ok. 23s)
...
Ilość uczesniów w zawodach notuje sporą zmienność. W ostatnich latach (po 2020 r. jak i po 2016r.) widoczny jest wyraźny dołek i spadek liczby zawodników poniżej 60 na zawody.
...
fig.add_trace(go.Pie(labels=df_control['wynik_kontroli'], 
...
Silne stymulanty układu nerwowego: Pseudoefedryna (12.1%), Amfetamina (9.09%) czy Kokaina (3.03%), służące do maksymalnego pobudzenia przed startem.

Sterydy anaboliczno-androgenne: Stanozolol (12.1%), Nandrolon (6.06%) czy Trenbolon (3.03%), budujące nienaturalną masę mięśniową i siłę. Świadczy to o tym, że doping nie jest przypadkowy (nie są to losowe zanieczyszczenia karmy), lecz jest to zaawansowany, celowy proceder.
...
Wykres powyżej pokazuje , że waga oraz wzrost chomików nie mają żadnego wpływu na osiągany przez nie czas. Żadna z ras, niezależnie od swoich gabarytów (czy to malutki chomik Roborowskiego, czy duży chomik europejski), nie zyskuje naturalnej przewagi fizycznej w tych konkretnych zawodach. Sukces zależy zatem od innych czynników np. ukrytego talentu, wytrenowania.
